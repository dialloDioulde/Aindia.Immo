    ...
    <?php if (count($offers) > 0) { ?>
        ...
        <table class="table">
            ...
            <?php foreach ($offers as $offer) : ?>
                ...
                <div class="modal fade offerEditModal mt-5" id="offerEditModal<?= $offer['id_offer'] ?>"
                     role="dialog">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-center" id="offerModalTitle">Édition d'une
                                    Offre</h5>
                            </div>
                            <div class="modal-body">
                                ...
                                <form id="editOfferForm" class="editOfferForm" enctype="multipart/form-data">
                                    <div class="form-row">
                                        ...
                                        <input type="hidden" id="imagesToDelete<?= $offer['id_offer'] ?>"
                                               name="imagesToDelete"/>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <input type="text" class="form-control" name="offerTime"
                                                   id="e_offerTime" value="<?= $offer['contract_offer'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-4">
                                            <label for="e_offerAvailable">Disponibilité : </label>
                                            <input type="date" class="form-control" name="offerAvailable"
                                                   id="e_offerAvailable"
                                                   value="<?= $offer['availablity_offer'] ?>">
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="e_offerPieces">Nombre de pièce(s) : </label>
                                            <input type="text" class="form-control" name="offerPieces"
                                                   id="e_offerPieces" value="<?= $offer['pieces_offer'] ?>">
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="e_offerArea">Surface (m2) : </label>
                                            <input type="text" class="form-control" name="offerArea"
                                                   id="e_offerArea" value="<?= $offer['area_offer'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-4">
                                            ...
                                            <input type="text" class="form-control" name="offerPrice"
                                                   id="e_offerPrice" value="<?= $offer['price_offer'] ?>">
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="e_offerCountry">Pays : </label>
                                            <input type="text" class="form-control" name="offerCountry"
                                                   id="e_offerCountry" value="<?= $offer['country_offer'] ?>">
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="e_offerCity">Ville : </label>
                                            <input type="text" class="form-control" name="offerCity"
                                                   id="e_offerCity" value="<?= $offer['city_offer'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-4">
                                            ...
                                            <input type="text" class="form-control" name="offerPostalCode"
                                                   id="e_offerPostalCode"
                                                   value="<?= $offer['postal_code_offer'] ?>">
                                        </div>
                                        <div class="form-group col-8">
                                            <label for="e_offerAddress">Adresse : </label>
                                            <input type="text" class="form-control" name="offerAddress"
                                                   id="e_offerAddress" value="<?= $offer['location_offer'] ?>">
                                        </div>
                                    </div>
                                    <div class="row m-1 mt-1 mb-2">
                                        <div class="form-check col-md-3">
                                            <input class="form-check-input" name="checkBoxValue[]"
                                                   type="checkbox"
                                        ...
                                        <div class="form-check col-md-3">
                                            <input class="form-check-input" name="checkBoxValue[]"
                                                   type="checkbox"
                                                   value="Cuisine Commune" id="flexCheckDefault">
                                        ...
                                        <div class="form-check col-md-3">
                                            <input class="form-check-input" name="checkBoxValue[]"
                                                   type="checkbox"
                                                   value="Douche Publique" id="flexCheckDefault">
                                            <label class="form-check-label" for="flexCheckDefault">
                                                Douche Commune
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check col-md-3">
                                            <input class="form-check-input" name="checkBoxValue[]"
                                                   type="checkbox"
                                                   value="Parking Gratuit" id="flexCheckChecked">
                                            <label class="form-check-label" for="flexCheckChecked">
                                                Parking Gratuit
                                            </label>
                                        </div>
                                        <div class="form-check col-md-3">
                                            <input class="form-check-input" name="checkBoxValue[]"
                                                   type="checkbox"
                                                   value="Parking Payant" id="flexCheckChecked">
                                            <label class="form-check-label" for="flexCheckChecked">
                                                Parking Payant
                                            </label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="e_offerDescription"
                                                  name="offerDescription"
                                                  rows="4"><?= $offer['description_offer'] ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="numberOfImage">Photo(s): </label>
                                        <input type="file" class='form-control-file mt-1' name="offerImage[]"
                                               multiple="multiple"
                                               id="offerImage"/>
                                    </div>
                                    ...
                                    <div class="row p-2" id="displayImages">
                                        ...
                                        <?php foreach ($images as $image) { ?>
                                            <img class="edit-image m-1"
                                                 src="<?= URL ?><?= $image['url_image'] ?>"
